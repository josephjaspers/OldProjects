...
DEPFILES/UNSIGNDEF_DEFS/%.o: ../DEPFILES/UNSIGNDEF_DEFS/%.cu
	...
	/usr/local/cuda-8.0/bin/nvcc -I/home/joseph/cuda-workspace/BlackCat_Tensors/BC_Headers -G -g -O0 -std=c++11 -gencode arch=compute_52,code=sm_52  -odir "DEPFILES/UNSIGNDEF_DEFS" -M -o "$(@:%.o=%.d)" "$<"
