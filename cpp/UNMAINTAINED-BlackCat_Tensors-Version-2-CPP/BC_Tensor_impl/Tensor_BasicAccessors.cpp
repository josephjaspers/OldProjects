...
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::total_matrices() const {
	unsigned total = 1;
...
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::matrix_size() const {
	return rows() * cols();
}
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::size() const {
	return sz;
}
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::rows() const {
	return order > 0 ? ranks[0] : 1;
}
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::cols() const {
	return order > 1 ? ranks[1] : 1;
}
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::pages() const {
...
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::rank(unsigned rank_index) const {
	return rank_index < degree() ? ranks[rank_index] : 1;
}

template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::leading_dim(unsigned rank_index) const {
	return rank_index < order ? ld[rank_index] : sz;
}
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::degree() const {
	return order;
}

template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::outerLD() const {
	return ld[order - 1];
}
template<typename n, typename TensorOperations> unsigned Tensor<n, TensorOperations>::outerRank() const {
