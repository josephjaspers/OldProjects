...
DEPFILES/%.o: ../DEPFILES/%.cpp
	...
	nvcc -I/home/joseph/cuda-workspace/BlackCat_Tensors/BC_Headers -O2 -std=c++11 -gencode arch=compute_52,code=sm_52  -odir "DEPFILES" -M -o "$(@:%.o=%.d)" "$<"
	nvcc -I/home/joseph/cuda-workspace/BlackCat_Tensors/BC_Headers -O2 -std=c++11 --compile  -x c++ -o  "$@" "$<"
