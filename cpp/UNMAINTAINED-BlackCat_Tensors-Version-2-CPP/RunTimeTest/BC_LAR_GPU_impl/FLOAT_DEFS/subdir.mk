...
BC_LAR_GPU_impl/FLOAT_DEFS/%.o: ../BC_LAR_GPU_impl/FLOAT_DEFS/%.cu
	...
	/usr/local/cuda-8.0/bin/nvcc -I/home/joseph/cuda-workspace/BlackCat_Tensors/BC_Headers/BC_HEADERS_GPU_TYPES -I/home/joseph/cuda-workspace/BlackCat_Tensors/BC_Headers/BC_HEADERS_GPU_TYPES -I/home/joseph/cuda-workspace/BlackCat_Tensors/BC_Headers -O2 -std=c++11 -gencode arch=compute_50,code=sm_50 -gencode arch=compute_52,code=sm_52  -odir "BC_LAR_GPU_impl/FLOAT_DEFS" -M -o "$(@:%.o=%.d)" "$<"
