...
public:
	...
	//--------------------------------------------------------Pointwise linear methods--------------------------------------------------------//
	//Pure pointwise methods (no LD)
	static void copy(number_type* store, const number_type* v, unsigned sz);
	static void port_copy(number_type* device, const number_type* host, unsigned sz);
	...
	static void zeros(number_type* m, unsigned sz);
	//Advanced -- no padding
	...
	static void dot(number_type* store, unsigned store_LD, const number_type* m1, unsigned m1_row, unsigned m1_col, unsigned m1_inc, const number_type* m2, unsigned m2_row, unsigned m2_col, unsigned m2_inc);
	...
	static void correlation(number_type* s, unsigned order, const unsigned* ranks, const number_type* filter, const unsigned* f_ld, const number_type* signal, const unsigned* s_ld);

	static void cross_correlation(number_type* s, unsigned cor_mv, const unsigned* store_ld, const number_type* filter, const unsigned * f_ld, const unsigned* f_ranks, unsigned f_order, const number_type* signal, const unsigned * s_ld, const unsigned* s_ranks, unsigned s_order);
