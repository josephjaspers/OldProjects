...
//}
template<>
void Tensor_Operations<float>::dot(float * s, unsigned s_LD, const float * m1, unsigned m1_rows, unsigned m1_cols, unsigned m1_LD,
...
template<>
void Tensor_Operations<double>::dot(double * s, unsigned s_LD, const double * m1, unsigned m1_rows, unsigned m1_cols, unsigned m1_LD,
...
template<typename number_type>
void Tensor_Operations<number_type>::dot(number_type* store, unsigned s_inc, const number_type* m1, unsigned m1_r, unsigned m1_c, unsigned m1_inc,
