...
public:
    ...
    static void max_index(const number_type* m, unsigned* ld, unsigned* ranks, unsigned order, unsigned* max_index);
    static void min_index(const number_type* m, unsigned* ld, unsigned* ranks, unsigned order, unsigned* min_index);
